...
# Fine-Tuned Weight
model_restoration.load_state_dict(torch.load('./pts/2_3fine_tuned_model12.pt'))
...
pretrained_denoising = cv2.cvtColor(cv2.imread('C:/Users/NDT/Desktop/Image_denoising/Data/test_patches_2/gaussian/Chest1(3072_3072)_IP.dcm.png/8_10.png'), cv2.COLOR_BGR2GRAY)
